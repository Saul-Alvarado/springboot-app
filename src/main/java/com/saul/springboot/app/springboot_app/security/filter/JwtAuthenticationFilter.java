...
import static com.saul.springboot.app.springboot_app.security.TokenJwtConfig.*;
...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter{
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
            ...
            response.addHeader(HEAD_AUTHORIZATION, PREFIX_TOKEN + token);

            Map<String, String> body = new HashMap<>();
            body.put("token", token);
            body.put("username", username);
            body.put("messsage", String.format("Hola %s has iniciado session correctamente", username));
